...
public class PropertyTO implements java.io.Serializable, NodeTO {
    ...
    private NamedNode nodeValue;
    private String rawValue;

    public PropertyTO() {
    }

    public PropertyTO(String id, PropertyTypeTO propertyType, String stringValue, Integer intValue, Boolean booleanValue, Double floatValue, Double latitudeValue, Double longitudeValue, Double rangeFromValue, Double rangeToValue, NamedNode nodeValue, String rawValue) {
        this.id = id;
    ...
    public NamedNode getNodeValue() {
        return nodeValue;
    }

    public void setNodeValue(NamedNode nodeValue) {
        this.nodeValue = nodeValue;
    }
    ...
    public static class Builder {
        ...
        public Builder setNodeValue(NamedNode nodeValue) {
            this.nodeValue = nodeValue;
            return this;
        }
