...
public class ServiceOrderItemResponseProjection extends GraphQLResponseProjection {
    ...
    public ServiceOrderItemResponseProjection all$(int maxDepth) {
        ...
        this.state();
        if (projectionDepthOnFields.getOrDefault("ServiceOrderItemResponseProjection.ErrorMessageResponseProjection.errorMessage", 0) <= maxDepth) {
            projectionDepthOnFields.put("ServiceOrderItemResponseProjection.ErrorMessageResponseProjection.errorMessage", projectionDepthOnFields.getOrDefault("ServiceOrderItemResponseProjection.ErrorMessageResponseProjection.errorMessage", 0) + 1);
            this.errorMessage(new ErrorMessageResponseProjection().all$(maxDepth - projectionDepthOnFields.getOrDefault("ServiceOrderItemResponseProjection.ErrorMessageResponseProjection.errorMessage", 0)));
        }
        this.typename();
        return this;
    }
    ...
    public ServiceOrderItemResponseProjection referredType() {
        return referredType(null);
    }

    public ServiceOrderItemResponseProjection referredType(String alias) {
    ...
    public ServiceOrderItemResponseProjection errorMessage(ErrorMessageResponseProjection subProjection) {
        return errorMessage(null, subProjection);
    }

    public ServiceOrderItemResponseProjection errorMessage(String alias, ErrorMessageResponseProjection subProjection) {
        fields.add(new GraphQLResponseField("errorMessage").alias(alias).projection(subProjection));
        return this;
    }
