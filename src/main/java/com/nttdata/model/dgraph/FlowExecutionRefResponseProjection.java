...
public class FlowExecutionRefResponseProjection extends GraphQLResponseProjection {
    ...
    public FlowExecutionRefResponseProjection baseFlow() {
        return baseFlow(null);
    }

    public FlowExecutionRefResponseProjection baseFlow(String alias) {
        fields.add(new GraphQLResponseField("baseFlow").alias(alias));
        return this;
    }
