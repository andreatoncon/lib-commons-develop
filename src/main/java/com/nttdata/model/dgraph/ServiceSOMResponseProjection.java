...
public class ServiceSOMResponseProjection extends GraphQLResponseProjection {
    ...
    public ServiceSOMResponseProjection supportingResource(SupportingResourceResponseProjection subProjection) {
        return supportingResource(null, subProjection);
    }

    public ServiceSOMResponseProjection supportingResource(String alias, SupportingResourceResponseProjection subProjection) {
