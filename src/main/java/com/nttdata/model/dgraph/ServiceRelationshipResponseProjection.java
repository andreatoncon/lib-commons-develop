...
public class ServiceRelationshipResponseProjection extends GraphQLResponseProjection {
    ...
    public ServiceRelationshipResponseProjection services(ServiceSOMResponseProjection subProjection) {
        return services(null, subProjection);
    }

    public ServiceRelationshipResponseProjection services(String alias, ServiceSOMResponseProjection subProjection) {
