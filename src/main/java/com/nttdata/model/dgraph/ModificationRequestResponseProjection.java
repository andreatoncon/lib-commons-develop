...
public class ModificationRequestResponseProjection extends GraphQLResponseProjection {
    ...
    public ModificationRequestResponseProjection type() {
        return type(null);
    }

    public ModificationRequestResponseProjection type(String alias) {
        fields.add(new GraphQLResponseField("type").alias(alias));
        return this;
    }

    public ModificationRequestResponseProjection state() {
        return state(null);
    }

    public ModificationRequestResponseProjection state(String alias) {
