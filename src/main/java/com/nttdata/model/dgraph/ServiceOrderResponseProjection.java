...
public class ServiceOrderResponseProjection extends GraphQLResponseProjection {
    ...
    public ServiceOrderResponseProjection completionDate() {
        return completionDate(null);
    }

    public ServiceOrderResponseProjection completionDate(String alias) {
        fields.add(new GraphQLResponseField("completionDate").alias(alias));
        return this;
    }
    ...
    public ServiceOrderResponseProjection flowExecutionRef(String alias, FlowExecutionRefResponseProjection subProjection) {
        fields.add(new GraphQLResponseField("flowExecutionReference").alias(alias).projection(subProjection));
        return this;
    }
