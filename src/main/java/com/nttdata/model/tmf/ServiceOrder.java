...
public class ServiceOrder extends BaseNode {
    ...
    public String toString() {
        ...
        if (getCompletionDate() != null) {
            joiner.add("completionDate: " + GraphQLRequestSerializer.getEntry(getCompletionDate()));
        }
        //
        ...
        if (getFlowExecutionRef() != null) {
            joiner.add("flowExecutionReference: " + GraphQLRequestSerializer.getEntry(getFlowExecutionRef()));
        }
